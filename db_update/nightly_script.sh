#!/bin/bash
echo Running update program at $(date).
go run /var/www/html/OrgFinder/db_update/*.go <db_username> <db_name> <password> &&
...
php5 /var/www/html/OrgFinderDeprecated/dbPop/populate_icons.php <db_username> <password> &&
