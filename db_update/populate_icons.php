<?php
	...
	@Description:
	This is deprecated code from the last version of the org finder.
	
	The Golang update script only downloads icons orgs that change,
	or for newly discovered orgs.
	
	This php script downloads images for orgs that require a custom,
	but do not currently have one downloaded. That's useful if the
	image is deleted, or if the initial download fails
	*/
